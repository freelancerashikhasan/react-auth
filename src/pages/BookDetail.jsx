...
useEffect(() => {
  ...
  const hasYouTubeVideo = book.video_link;
                  ...
                  <div className="book-info-section">
                    ...
                    <h1 className="book-title">{book.title}</h1>
                      ...
                      <div className="price-notes">
                        <span>+ Delivery Charge: Inside Dhaka {book.delivery_charge_dhaka || 60} BDT</span>
                        <span>Outside Dhaka {book.delivery_charge || 90} BDT</span>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="">
                        ...
                        onClick={() => {
                          ...
                          window.location.href = `/checkout?book=${id}&quantity=${quantity}`;
                        }}
                      >
                        Buy Now
                    ...
                    <div className="book-image">
                      ...
                      <div className="book-overlay">
                        <button 
                          ...
                          onClick={() => window.location.href = `/books/${relatedBook.id}`}
                        >
                          <Eye size={20} />
                        </button>
                      </div>
